...
(function() {
  ...
  GoogleDrive = (function() {
    ...
    GoogleDrive._arrayBufferToBase64 = function(buffer) {
    ...
    GoogleDrive._makeBody = function(metadata, contentType, data) {
    ...
    GoogleDrive.writeFile = function(buffer, cb) {
      ...
      body = this._makeBody(metadata, contentType, this._arrayBufferToBase64(buffer));
  ...
  BrowserFS.File.GDriveFile = (function(_super) {
    ...
    GDriveFile.prototype.sync = function(cb) {
      return GoogleDrive.writeFile(this._buffer.buff.buffer, cb);
    };
